...
<table width="959" height="25" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr bgcolor="#F0F0F0">
<?		
		if(!$cookie_no){echo("<td width='181' align='center'><font color='#666666'>&nbsp <b>Welcome ! &nbsp;&nbsp
		고객님.
		</b></font></td>");
		}
		else{
		echo("<td width='181' align='center'><font color='#666666'>&nbsp <b>Welcome ! &nbsp;&nbsp
		$cookie_name 님.
		</b></font></td>");
		}
?>		
			...
			<table width="181" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td valign="top"> 
						...
						<table width="177"  border="0" cellpadding="2" cellspacing="1" bgcolor="#afafaf">
							...
							<tr><td height="25"  align="center" style="font-size:11pt;color:#333333">Category</td></tr>
							<tr>
							<tr>
								<td bgcolor="#FFFFFF">
				...
				<tr> 
					<td> 
						...
						<table width="177"  border="0" cellpadding="2" cellspacing="1" bgcolor="#afafaf">
							<tr><td height="3"  bgcolor="#a0a0a0"></td></tr>
							<tr><td height="25"  align="center" style="font-size:11pt;color:#333333">Customer Service</td></tr>
							<tr>
								<td bgcolor="#FFFFFF">
									<table width="100%"  border="0" cellspacing="0" cellpadding="0">
