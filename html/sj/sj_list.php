...
<?
	if(!$text1)
		$query="select * from sj order by name7;";
	else
		$query="select * from sj where name7 like '%$text1%' order by name7;";
	...
	echo(" <tr bgcolor='lightyellow'>
				<td width='100'>
					<a href='sj_edit.php?no=$row[no7]'>$row[name7]</a>
				</td>
				<td width='50'  align='right'>$row[kor7]</td>
				<td width='50'  align='right'>$row[eng7]</td>
				<td width='50'  align='right'>$row[mat7]</td>
				<td width='50'  align='right'>$row[hap7]</td>
				<td width='50'  align='right'>$row[avg7]</td>
				<td align='center'>
					<a href='sj_delete.php?no=$row[no7]'
